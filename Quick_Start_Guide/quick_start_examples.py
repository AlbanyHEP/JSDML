...
'''
import public_net as pn
import numpy as np
import random
from matplotlib import pyplot as plt

#	Example 1 - 5D Gausians
train_x, train_y, test_x, test_y = pn.create_feature_sets_and_labels( "QuickStartGaussSignal.csv",
...
network = pn.nnet( layer_vector, learning_rate=0.05, decay_value=1e-5 )
...
mutual = pn.mi(network.normalize_data(train_x),train_y,k=1)
...
train_x, train_y, test_x, test_y = pn.create_feature_sets_and_labels( "QuickStartMagicSignal.csv",
...
train_x, train_y, test_x, test_y = pn.create_feature_sets_and_labels( "QuickStartBCSignal.csv",
...
for i in range(100):
	...
	JSD_list.append(pn.mi(temp_train_x,temp_train_y,k=1))
...
#	Blank Code
train_x, train_y, test_x, test_y = pn.create_feature_sets_and_labels( "",
																	  "", 
																	  num_of_vars=, 
																	  test_size=0.3, 
																	  file_size=0.999, 
